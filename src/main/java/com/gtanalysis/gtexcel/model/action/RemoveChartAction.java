 ...
 * @author nkabiliravi
 */
public class RemoveChartAction extends BaseAction {

    private final ExcelChartModel excelChartModel;

    public RemoveChartAction(WorkbookModel workbookModel, XSSFWorkbook workbook, ExcelChartModel excelChartModel) {
